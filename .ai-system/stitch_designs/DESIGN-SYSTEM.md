...
colors:
  ...
  primary: '#00482a'
  on-primary: '#ffffff'
  primary-container: '#00623b'
  on-primary-container: '#8adbaa'
  inverse-primary: '#87d7a6'
  secondary: '#006d3e'
  on-secondary: '#ffffff'
  secondary-container: '#78fcac'
  on-secondary-container: '#007442'
  tertiary: '#6d272a'
  on-tertiary: '#ffffff'
  tertiary-container: '#8a3d3f'
