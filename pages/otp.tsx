...
import VerificationForm from "../app/components/Otp/Verification";
import Main from "../app/components/Otp/LegendOtp";

const OtpPage = () => {
    return (
        <div className="h-screen overflow-y-hidden p-1 flex justify-center items-center">
