...
export default function DashboardNav() {
  ...
  return (
    <>
      ...
      {/* Desktop Sidebar */}
      <aside
        className={`hidden lg:flex flex-col shrink-0 sticky top-0 h-screen bg-bg-card border-r border-border transition-all duration-200 ${sidebarWidth}`}
      >
        {/* Sidebar Brand + Toggle */}
        <div className={`flex items-center pt-6 pb-4 ${sidebarCollapsed ? "justify-center px-2" : "justify-between px-5"}`}>
          {sidebarCollapsed ? (
