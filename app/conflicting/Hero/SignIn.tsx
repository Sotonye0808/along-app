...
const SignIn = () => {
  ...
  return (
    <div className="w-full h-full p-1 bg-gray-100 flex flex-col gap-2 justify-start md:justify-center items-start">
      <p className="text-3xl font-semibold my-3">Sign in</p>
      <form
        className="w-full flex flex-col gap-3 md:text-sm"
        ...
        <div className="w-full relative flex justify-center border rounded-md shadow-md px-4 py-2 text-gray-600 focus-within:outline-none focus-within:border-black">
          <label
            htmlFor="login-email"
            className="absolute left-2 text-sm text-gray-700 font-semibold">
            ✉
          </label>
          <input
            id="login-email"
        ...
        <div className="w-full my-1 flex md:justify-between justify-center items-center">
          <button
            type="submit"
            className="w-1/2 md:w-full bg-green-700 text-white py-2 rounded-lg hover:bg-gray-800"
            disabled={loading}>
        ...
        <div id="providers" className="w-full flex justify-between gap-5">
          <button
            type="button"
            className="w-4/6 bg-white border border-gray-300 shadow-md rounded-lg py-2 px-4 hover:bg-opacity-85">
